...
No production behavior change without first seeing a relevant test fail, unless the user explicitly chooses an exception.
...
- generated code
- purely textual docs
- mechanical config with no test harness
