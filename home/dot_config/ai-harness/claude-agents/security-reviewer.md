...
- relevant architecture, domain, durable decisions, acceptance artifact, plan, review notes, and
  changed files
...
Output findings first, ordered by P0-P3 severity, with impact, evidence, and concrete mitigation.
Avoid speculative vulnerabilities without evidence.
